...
interface
uses
  System.SysUtils,GetBios,LocalData,GetActiveNetworkSetting,GetCPU,
  GetMainboard,GetSys,GetChassis,GetOS,GetHardDisk,GetVideoCard,
  GetCDRom,GetLogicDisk,GetMemory,GetModem,GetNetworkAdapter,
  GetPrinter,GetPublicDevices,GetSoftwares,GetUserAccount,SQLData,
  GetGroupAccount,GetAgentProperties;
