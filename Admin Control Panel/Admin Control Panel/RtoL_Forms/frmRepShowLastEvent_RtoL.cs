...
{
    public partial class frmRepShowLastEvent_RtoL : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmRepShowLastEvent_RtoL(Agents Agent)
        {
            _agent = Agent;
            _agentId = _agent.AgentID;
            _langCode = Program.LangCode.ToString();
            _agentName = _agent.ComputerName;    
            InitializeComponent();
        }

        private void frmRepShowLastEvent_RtoL_Load(object sender, EventArgs e)
        {
            FillData();
        }
        ...
        private void FillData()
        {
            ...
            this.Text = lg.GetMessageFromDll(_langCode, "NewEventsShow") + "  " + _agent.ComputerName;
            ...
            dt = lg.GetNonShownAgentEvents(_agent.AgentID);
        ...
        private void frmRepShowLastEvent_RtoL_Shown(object sender, EventArgs e)
        {
            this.radGridView1.GridViewElement.GroupPanelElement.Text = _groupPanelText;
            Program.ReportReady = true;
        }

        private void frmRepShowLastEvent_RtoL_FormClosing(object sender, FormClosingEventArgs e)
        {
            Program.AgentList[_agent.AgentMainIndex].AlertLevelId = null;
        }
        ...
        private void CreateReport()
        {
            try
            {
                ...
                stiReport1["PFromDate"] = _fromDate;
                stiReport1["PToDate"] = _toDate;
        ...
        private DataTable GetParentDataTable()
        {
            ...
            _fromDate = EventList[0].date;
            _toDate = EventList[rowCount - 1].date;
